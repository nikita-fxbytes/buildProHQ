...
export const ALLOWED_TASK_STATUS_NAMES = ['Open', 'In Progress', 'Completed'] as const;
...
export class UpdateTaskStatusDto {
  ...
  @IsIn(ALLOWED_TASK_STATUS_NAMES, { message: MESSAGES.TASK_VALIDATION.STATUS_NAME_INVALID })
